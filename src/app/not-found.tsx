  ...
  return (
    <Shell className="grid min-h-[60vh] place-items-center py-20">
      <GlassCard className="max-w-xl p-8 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#E6FAF3]">Empty state</p>
        ...
        <Link
          href="/"
          className="mt-6 inline-flex min-h-12 items-center justify-center rounded-full bg-[#38D6B0] px-6 py-3 text-sm font-bold text-[#07111F]"
        >
          Return home
        </Link>
      </GlassCard>
