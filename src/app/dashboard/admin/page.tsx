  ...
  return (
    <main className="min-h-screen bg-[#F3F7F5] text-[#143A35]">
      ...
      <div className="mx-auto max-w-[1500px] px-5 py-6 sm:px-7">
        <section className="flex flex-col gap-3 rounded-md border border-[#D5E4E0] bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between" aria-label="Administrator operational scope">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.12em] text-[#70847E]">Operational scope</p>
            <p className="mt-1 text-sm font-semibold text-[#536B66]">Users, households, elders, assignments, cases, tasks, leads, subscriptions, consent, and audit.</p>
          </div>
          <span className="inline-flex w-fit rounded-md bg-[#E8F5F1] px-3 py-2 text-sm font-bold text-[#087B69]">Overview</span>
        </section>
