  ...
  return (
    <main className="min-h-screen bg-[#F4F8F6] px-5 py-12 text-[#143A35] sm:px-7 sm:py-20">
      <section className="mx-auto max-w-xl rounded-md border border-[#CFE0DB] bg-white p-6 shadow-xl sm:p-8">
        ...
        {qrCode ? <div className="mt-6 grid gap-3 rounded-md border border-[#DCE9E5] bg-[#F8FBF9] p-4"><p className="text-sm font-bold">Scan this code in your authenticator app.</p><img src={qrCode} alt="Authenticator setup QR code" className="h-48 w-48 rounded-md border border-[#DCE9E5] bg-white p-2" /><p className="break-all font-mono text-xs text-[#536B66]">Manual key: {secret}</p></div> : null}
