...
- MVP dashboard route with family, elder, care-manager, admin, partner, corporate, and monthly report previews.
- React Hook Form + Zod lead capture flow with `/api/leads` placeholder.
- Supabase-ready repository interface, WhatsApp deep links, payment placeholders, sitemap, robots, Open Graph image, and JSON-LD metadata.
